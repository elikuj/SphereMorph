#   the effect of movement throughout the 3D plane on the spherical projection of a cube.
#
#   notably, the spherical projection has no self-intersections when it is closest to the sphere, but self-intersection
#   occurs as it moves further away.
